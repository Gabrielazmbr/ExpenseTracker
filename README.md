...
- Select 1 to add a new expenses, you will be asked to add the amount of the expense, the date, the category (can create new categories, or use categories created previusly.
...
Developed by Gabriela Zambrano.
